...
abstract class $LikeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String likeId, String memberId, DateTime createdAt});
}
...
class _$_Like implements _Like {
  _$_Like(
      {required this.likeId, required this.memberId, required this.createdAt});
  ...
  @override
  String toString() {
    return 'Like(likeId: $likeId, memberId: $memberId, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, likeId, memberId, createdAt);
